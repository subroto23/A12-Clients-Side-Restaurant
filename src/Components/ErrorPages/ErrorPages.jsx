  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <Link
          to="/"
          className="flex items-center space-x-2 bg-orange-400 hover:bg-gray-700 text-gray-100 px-4 py-2 rounded transition duration-150"
          title="Return Home"
        >
          <svg
      ...
      <div className="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
        <svg
          className="w-full text-orange-200"
          xmlns="http://www.w3.org/2000/svg"
          data-name="Layer 1"
          viewBox="0 0 1120.59226 777.91584"
        >
          <title>not found</title>
          <circle cx="212.59226" cy="103" r="64" fill="#FFA500"></circle>
          <path
          ...
          <circle cx="99.31925" cy="546.29477" r="9" fill="#FFA500"></circle>
          <path
          ...
          <circle cx="708.52153" cy="545.71023" r="9" fill="#FFA500"></circle>
          <path
