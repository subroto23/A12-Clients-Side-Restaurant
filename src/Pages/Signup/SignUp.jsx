...
const SignUp = () => {
  const { handleCreateUser, handleUpdateUser, handleLogOut, loading } =
    UseAuth();
  const SectionTitle = UseSectionTitle("Please", "SignUp", "md:mb-20");
  ...
  return (
    <div className="border-x border-orange-400">
      <HelmetHookes title={"SignUp | Pages"} />
      {SectionTitle}
      <div className="grid md:grid-cols-6 grid-cols-1 gap-x-6">
        ...
        {/* 2nd Div */}
        <div className="col-span-4 mb-4 px-2  md:px-4">
