...
const LogIn = () => {
  ...
  const SectionTitle = UseSectionTitle("Login", "First", "md:mb-20");
  ...
  return (
    <div className="border-x">
      ...
      <div className="grid md:grid-cols-6 grid-cols-1 gap-x-6">
        <div className="max-w-md col-span-2 text-center">
          <svg
            width="524.67004"
            height="531.39694"
            className="w-full stroke-orange-400"
        ...
        <div className="w-full mb-4 md:px-6 px-3 col-span-4 border-l">
          ...
          <div className="mb-12 flex md:justify-evenly md:flex-row flex-col">
            ...
            <button className="text-grey-dark">
              ...
              <Link
                to="/signup"
                className="text-orange-400 hover:font-bold font-medium text-lg mx-2"
              >
                Register
              </Link>
            </button>
